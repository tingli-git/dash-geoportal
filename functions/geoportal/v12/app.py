# functions/geoportal/v12/app.py
...
# solara run --production /datawaha/esom/Ting/Projects/DatePlamMapping/gitrepo/dash-geoportal/functions/geoportal/v12/app.py 
...
from functions.geoportal.v12.state import ReactiveRefs
from functions.geoportal.v12.basemap import (
    create_base_map, osm_layer, esri_world_imagery_layer,
    ensure_controls, ensure_base_layers,
)
from functions.geoportal.v12.layers import (
    upsert_overlay_by_name, set_layer_opacity,
)
from functions.geoportal.v12.widgets import use_debounce
from functions.geoportal.v12.errors import Toast, use_toast
from functions.geoportal.v12.geojson_loader import load_icon_group_from_geojson
from functions.geoportal.v12.timeseries import resolve_csv_path, read_timeseries, build_plotly_widget
from functions.geoportal.v12.center_pivot_loader import build_center_pivot_layer
from shapely.geometry import mapping, box

from functions.geoportal.v12.datepalm_loader import build_datepalms_layer  # NEW
from functions.geoportal.v12.ksa_bounds_loader import build_ksa_bounds_layer
from functions.geoportal.v12.tree_health_loader import build_tree_health_layer, clear_tree_health_highlight
