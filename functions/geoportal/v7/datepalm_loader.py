# functions/geoportal/v7/datepalm_loader.py
...
from functions.geoportal.v7.popups import show_popup
from functions.geoportal.v7.timeseries import _to_time_strings  # 👈 NEW
