# functions/geoportal/v10/datepalm_loader.py
...
from functions.geoportal.v10.popups import show_popup
from functions.geoportal.v10.timeseries import _to_time_strings  # 👈 NEW
