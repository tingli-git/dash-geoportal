# functions/geoportal/v11/config.py
...
class Config:
    ...
    datepalms_province_http_base: str = "http://127.0.0.1:8766/datepalms_per_province"
    ...
    ksa_bounds_http_base: str = "http://127.0.0.1:8766/ksa_bounds"
    ksa_bounds_http_url: str = "http://127.0.0.1:8766/ksa_bounds/KSA_provincebounds.gpkg"
