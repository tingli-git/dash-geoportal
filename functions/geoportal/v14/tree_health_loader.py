# functions/geoportal/v14/tree_health_loader.py
...
from functions.geoportal.v14.popups import show_tree_health_badge
from functions.geoportal.v14.utils import padded_bounds
    ...
    for feature in features:
        ...
        def _make_click_handler(lat_val, lon_val, props_snapshot, marker_ref):
            def _handler(**_):
                ...
                show_tree_health_badge(m, props_snapshot)
            return _handler
...
def build_tree_health_layer(
    *,
    ...
    geojson_path = ensure_local_asset(Path(getattr(CFG, "tree_health_geojson_file", "")))
    if not geojson_path:
